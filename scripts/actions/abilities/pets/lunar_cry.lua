...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    target:addStatusEffect(xi.effect.ACCURACY_DOWN, { power = buffValue, duration = xi.job_utils.summoner.wardDuration(summoner, 180), origin = pet })
    target:addStatusEffect(xi.effect.EVASION_DOWN, { power = 32-buffValue, duration = xi.job_utils.summoner.wardDuration(summoner, 180), origin = pet })
