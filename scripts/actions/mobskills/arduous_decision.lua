...
-- Description: Single target great axe attack. Additional effect: Silence.
-- Fragmentation/Compression skillchain properties (BG Wiki)
...
mobskillObject.onMobWeaponSkill = function(mob, target, skill, action)
    ...
    params.numHits        = 1
    params.fTP            = { 2.0, 2.5, 3.0 } -- TODO: Capture fTPs (estimate)
